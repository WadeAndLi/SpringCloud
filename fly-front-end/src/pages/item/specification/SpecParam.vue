    ...
    <div>
        <v-data-table
            ...
            <template slot="items" slot-scope="props">
                ...
                <td class="text-xs-center">{{ props.item.k }}</td>
                <td class="text-xs-center">{{ formatBoolean(props.item.numeric) }}</td>
                <td class="text-xs-center">{{ props.item.unit || '无' }}</td>
                <td class="text-xs-center">{{ formatBoolean(props.item.global) }}</td>
                <td class="text-xs-center">{{ formatBoolean(props.item.searchable) }}</td>
